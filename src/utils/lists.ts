...
export const listCabins: Cabins[] = [
    ...
    },
    {
      ...
      price: 984,
      description: 'Admira las vistas panorámicas del océano en este cabina exterior. La cabina "Cimopolia’s Bonanza" te sumergirá en la serenidad del mar con su decoración. Descubre la calma del océano mientras te relajas en la comodidad de tu cabina y te deleitas con la belleza del mar en todo su esplendor. Puedes escoger entre single, doble, triple, y cuádruple',
      features: [
        'All inclusive drinks',
        'House keeper',
        'TV  Smart satelital',
